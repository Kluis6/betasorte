...
function LoteriaInfo() {
    ...
    return (React.createElement("div", { className: "grid grid-cols-12 gap-4" }, loterias ? (loterias.map(function (loteria, index) { return (React.createElement("div", { className: "col-span-4 bg-neutral-50 border border-neutral-300 p-2 relative overflow-hidden", key: index },
